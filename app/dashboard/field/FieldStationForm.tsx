    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-3 gap-3">
          <input name="grav1" placeholder="G1" value={form.grav1} onChange={handleChange} className="p-2.5 rounded-lg bg-neutral-800 border border-neutral-700 outline-none" />
          <input name="grav2" placeholder="G2" value={form.grav2} onChange={handleChange} className="p-2.5 rounded-lg bg-neutral-800 border border-neutral-700 outline-none" />
          <input name="grav3" placeholder="G3" value={form.grav3} onChange={handleChange} className="p-2.5 rounded-lg bg-neutral-800 border border-neutral-700 outline-none" />
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <input name="mag1" placeholder="M1" value={form.mag1} onChange={handleChange} className="p-2.5 rounded-lg bg-neutral-800 border border-neutral-700 outline-none" />
          <input name="mag2" placeholder="M2" value={form.mag2} onChange={handleChange} className="p-2.5 rounded-lg bg-neutral-800 border border-neutral-700 outline-none" />
        </div>
      </div>
